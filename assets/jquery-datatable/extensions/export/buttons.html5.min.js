(function(g) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables_old.net", "datatables_old.net-buttons"], function(i) {
        return g(i, window, document)
    }) : "object" === typeof exports ? module.exports = function(i, j, t, u) {
        i || (i = window);
        if (!j || !j.fn.dataTable) j = require("datatables_old.net")(i, j).$;
        j.fn.dataTable.Buttons || require("datatables_old.net-buttons")(i, j);
